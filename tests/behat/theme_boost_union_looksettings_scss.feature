...
Feature: Configuring the theme_boost_union plugin for the "SCSS" tab on the "Look" page
  ...
  Scenario: Setting: Raw initial external SCSS - Add custom SCSS URL to the theme
    ...
    And I set the field "Raw initial SCSS URL" to "https://raw.githubusercontent.com/muellerlukas/moodle-theme_boost_union/master/tests/fixtures/pre_scss_url.txt"
    And I press "Save changes"
    And I am on "Course 1" course homepage
    Then I should not see "Course 1" in the "#page-header .page-header-headings" "css_element"